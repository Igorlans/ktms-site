<?php
        ...
        if(!$asset->hasAccess())
        {
            WPDM_Messages::error(array('title' => 'Access Denied!', 'message' => __( "You do not have access to this asset", "download-manager" )), 1);
        }
...
<html lang="en">
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <div class="tab-content">
                ...
                <div data-target="tab-b" class="tab">
                    ...
                    <div class="d-flex"><div class="meta-name">Content Type</div><div class="meta-value"><?php echo mime_content_type($asset->path) ?></div></div>
                    <?php
        ...
        <div id="main">
            <div id="asset-viewer">
                <?php echo $asset->view($asset->path); ?>
            </div>
