                    ...
                    if(count($__wpdm_social_login) > 0) { ?>
                        <div class="col-sm-12">
                            <div class="text-center panel panel-default" style="margin: 20px 0 0 0">
                                <?php if(!$_social_only){ ?>
                                    <div class="panel-heading" data-toggle="collapse" href="#socialllogin" role="button" aria-expanded="false" aria-controls="socialllogin"><?php echo isset($params['social_title'])?$params['social_title']:__("Or connect using your social account", "download-manager"); ?></div>
                                <?php } else { ?>
                                    <div class="panel-heading"><?php echo isset($params['social_title'])?$params['social_title']:__("Connect using your social account", "download-manager"); ?></div>
                                <?php } ?>
                ...
                jQuery(function ($) {
                    ...
                    $('#registerform').submit(function (e) {
                        ...
                        if( $('#reg_password').val() !== $('#reg_confirm_pass').val() ){
                            ...
                            WPDM.beep();
                            WPDM.notify("<?php echo __( "Password did not match with the confirm password", "download-manager" ) ?>", "error", "top-right", 7000);
                            return false;
                        } else {
                    ...
                    ?>
                    WPDM.notify("<div class='media'><div class='pull-left'><i class='fas fa-user-injured fa-3x' style='opacity: 0.8'></i></div><div class='media-body'><strong><?php _e( "Signup Error:", "download-manager" ); ?></strong><br/><?php echo $error; ?></div></div>", 'error', 'top-right');
                    <?php
