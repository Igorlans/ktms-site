...
class WPDM_ListPackages extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <label><?php echo __( "On Single Download Page", "download-manager" ); ?>:</label>
            <label><?php _e( "Show packages from current package category", "download-manager" ) ?><input type="checkbox" value="1" name="<?php echo $this->get_field_name('cpc'); ?>" id="<?php echo $this->get_field_id('cpc'); ?>"></label>
