    ...
    function widget($args, $instance) {
        ...
        if($style == 'flat') {
            ...
            foreach ($terms as $term) {
                echo "<a href='" . get_term_link($term) . "'  class='list-group-item d-flex justify-content-between align-items-center text-default'>{$term->name}<span class='badge badge-info'>{$term->count}</span></a>\n";
            }
